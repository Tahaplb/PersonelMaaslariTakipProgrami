<%@ Page Language="C#" AutoEventWireup="true" Codefile="frm_WageDataEntry.aspx.cs" Inherits="PMTP_Taha.frm_WageDataEntry" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table class="auto-style1">
                ...
                <tr>
                    <td class="auto-style5">Maaş Ayı</td>
                    <td class="auto-style3">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Sayfayı Kapat" OnClientClick="window.close()" />
                    </td>
                </tr>
                <tr>
